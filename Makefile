...
NETWORK_ARGS2 := --rpc-url http://localhost:8545 --account (defaultkey name) --sender (the address) --broadcast -vvv
...
deploy-sepolia:
  ...
  deploy2:
	@forge script script/DeployFundMe.s.sol:DeployFundMe $(NETWORK_ARGS2)
